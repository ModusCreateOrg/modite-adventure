...
GProcess *GProcess::Spawn(GGameState *aGameState, TInt16 mAttribute, TInt aIp, TFloat aX, TFloat aY, TUint16 aParams, DIRECTION aDirection, const char *aName) {
  ...
  switch (mAttribute) {
    ...
    case ATTR_MID_BOSS_FIRE:
      return aGameState->AddProcess(new GMidBossGenericProcess(aGameState, xx, yy, MID_BOSS_SLOT, ip, ATTR_MID_BOSS_FIRE, params, MID_BOSS_FIRE_BMP_SPRITES));
    case ATTR_MID_BOSS_EARTH:
      return aGameState->AddProcess(new GMidBossGenericProcess(aGameState, xx, yy, MID_BOSS_SLOT, ip, ATTR_MID_BOSS_EARTH, params, MID_BOSS_EARTH_BROWN_BMP_SPRITES));
    case ATTR_MID_BOSS_WATER:
      return aGameState->AddProcess(new GMidBossGenericProcess(aGameState, xx, yy, MID_BOSS_SLOT, ip, ATTR_MID_BOSS_WATER, params, MID_BOSS_WATER_BMP_SPRITES));
      break;
  }
  return ENull;
}
