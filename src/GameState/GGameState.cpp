...
void GGameState::PostRender() {
  ...
  screen->DrawString(&vp, "XP", gFont16x16, xp_x, 0, COLOR_TEXT, COLOR_TEXT_TRANSPARENT, -4);
  ...
  screen->DrawString(&vp, output, gFont16x16, 320 - l_width, 0, COLOR_TEXT, COLOR_TEXT_TRANSPARENT, -4);
}
