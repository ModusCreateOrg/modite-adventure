...
ANIMSCRIPT walkLeftAnimation1[] = {
  ABITMAP(PLAYER_SLOT),
  ADELTA(-10, 0),
  AFLIP(1, IMG_WALK_RIGHT + 0),
  ADELTA(0, 0),
  AFLIP(WALKSPEED, IMG_WALK_RIGHT + 1),
  ADELTA(-4, 0),
  AFLIP(WALKSPEED - 1, IMG_WALK_RIGHT + 2),
  ADELTA(0, 0),
  AEND,
};
...
ANIMSCRIPT walkLeftAnimation2[] = {
  ABITMAP(PLAYER_SLOT),
  ADELTA(-4, 0),
  AFLIP(1, IMG_WALK_RIGHT + 2),
  ADELTA(-6, 0),
  AFLIP(WALKSPEED, IMG_WALK_RIGHT + 3),
  ADELTA(-10, 0),
  AFLIP(WALKSPEED - 1, IMG_WALK_RIGHT + 0),
  ADELTA(0, 0),
  AEND,
};
...
ANIMSCRIPT walkUpAnimation1[] = {
  ...
  ADELTA(-7, 0),
  ASTEP(WALKSPEED - 1, IMG_WALK_UP + 2),
  ADELTA(0, 0),
  AEND,
};
...
ANIMSCRIPT walkUpAnimation2[] = {
  ABITMAP(PLAYER_SLOT),
  ADELTA(-7, 0),
  ASTEP(1, IMG_WALK_UP + 2),
  ADELTA(-1, 0),
  ASTEP(WALKSPEED, IMG_WALK_UP + 3),
  ADELTA(0, 0),
  ASTEP(WALKSPEED - 1, IMG_WALK_UP + 0),
  AEND,
};
