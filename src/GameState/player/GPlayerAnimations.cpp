...
ANIMSCRIPT swordDownAnimation[] = {
  ...
  ADELTA(-2, 22),
  ATYPE(STYPE_PBULLET),
  ASIZE(0, PLAYER_RECT_Y + 23, PLAYER_RECT_W + 8, 55 - PLAYER_RECT_H),
  ASTEP(SWORDSPEED, IMG_SWORD_DOWN + 1),

  // after the hit frame, reset type to STYPE_PLAYER
  ADELTA(-3, 22),
  ASIZE(PLAYER_RECT_X, PLAYER_RECT_Y, PLAYER_RECT_W, PLAYER_RECT_H),
  ATYPE(STYPE_PLAYER),
...
ANIMSCRIPT swordDownNoBulletAnimation[] = {
  ...
  ADELTA(-2, 22),
  //  ATYPE(STYPE_PBULLET),
  ASIZE(PLAYER_RECT_X, PLAYER_RECT_Y + 23, PLAYER_RECT_W, PLAYER_RECT_H + 23),
  ASTEP(SWORDSPEED, IMG_SWORD_DOWN + 1),
...
ANIMSCRIPT swordLeftAnimation[] = {
  ...
  ADELTA(-18, 0),
  ATYPE(STYPE_PBULLET),
  ASIZE(-32, PLAYER_RECT_Y, 32, PLAYER_RECT_H + 8),
...
ANIMSCRIPT swordLeftNoBulletAnimation[] = {
  ...
  ADELTA(-18, 0),
  //  ATYPE(STYPE_PBULLET),
  ASIZE(PLAYER_RECT_X - 32, PLAYER_RECT_Y, PLAYER_RECT_W + 8, PLAYER_RECT_H),
  AFLIP(SWORDSPEED, IMG_SWORD_RIGHT + 1),
  ADELTA(-18, 0),
  //  ATYPE(STYPE_PLAYER),
  ASIZE(PLAYER_RECT_X, PLAYER_RECT_Y, PLAYER_RECT_W, PLAYER_RECT_H),
...
ANIMSCRIPT swordRightAnimation[] = {
  ...
  ADELTA(20, 0),
  ATYPE(STYPE_PBULLET),
  ASIZE(PLAYER_RECT_X + PLAYER_RECT_W, PLAYER_RECT_Y, 32, PLAYER_RECT_H + 8),
...
ANIMSCRIPT swordRightNoBulletAnimation[] = {
  ...
  ADELTA(20, 0),
  //  ATYPE(STYPE_PBULLET),
  ASIZE(PLAYER_RECT_X + 16, PLAYER_RECT_Y, PLAYER_RECT_W + 40, PLAYER_RECT_H),
  ASTEP(SWORDSPEED, IMG_SWORD_RIGHT + 1),
...
ANIMSCRIPT swordUpAnimation[] = {
  ...
  ADELTA(2, -2),
  ATYPE(STYPE_PBULLET),
  ASIZE(0, PLAYER_RECT_Y - PLAYER_RECT_H, PLAYER_RECT_W + 8, 58 - PLAYER_RECT_H),
...
ANIMSCRIPT swordUpNoBulletAnimation[] = {
  ...
  ADELTA(2, -2),
  //  ATYPE(STYPE_PBULLET),
  ASIZE(PLAYER_RECT_X, PLAYER_RECT_Y, PLAYER_RECT_W, PLAYER_RECT_H + 26),
  ASTEP(SWORDSPEED, IMG_SWORD_UP + 1),
