...
const TUint16 ATTR_GOBLIN_SNIPER_TURRET = 35;
const TUint16 ATTR_ELEMENTAL_SKULL_EARTH = 36;
const TUint16 ATTR_ELEMENTAL_SKULL_WATER = 37;
const TUint16 ATTR_ELEMENTAL_SKULL_FIRE = 38;
const TUint16 ATTR_ELEMENTAL_SKULL_ENERGY = 39;
// mid bosses
