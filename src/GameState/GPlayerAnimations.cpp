...
ANIMSCRIPT swordDownAnimation[] = {
  ...
  ATYPE(STYPE_PBULLET),
  ASIZE(0,23, 32,55),
  ASTEP(SWORDSPEED*10, IMG_SWORD_DOWN + 1),

  // after the hit frame, reset type to STYPE_PLAYER
  ADELTA(-3,22),
  ASIZE(0,0, 32,32),
  ATYPE(STYPE_PLAYER),
  ASTEP(SWORDSPEED*10, IMG_SWORD_DOWN + 2),
...
ANIMSCRIPT swordLeftAnimation[] = {
  ...
  ATYPE(STYPE_PBULLET),
  ASIZE(-32, 0, 40,32),
  AFLIP(SWORDSPEED*10, IMG_SWORD_RIGHT + 1),
  ADELTA(-18,0),
  ATYPE(STYPE_PLAYER),
  ASIZE(0, 0, 32,32),
...
ANIMSCRIPT swordRightAnimation[] = {
  ...
  ATYPE(STYPE_PBULLET),
  ASIZE(16, 0, 72,32),
  ASTEP(SWORDSPEED*10, IMG_SWORD_RIGHT + 1),
...
ANIMSCRIPT swordUpAnimation[] = {
  ...
  ATYPE(STYPE_PBULLET),
  ASIZE(0, 0, 32,58),
  ASTEP(SWORDSPEED*10, IMG_SWORD_UP + 1),
