...
static ANIMSCRIPT tauntAnimation[] = {
  ABITMAP(ORC_SLOT),
  ASTEP(TAUNT_SPEED, IMG_ORG_IDLE + 0),
  ASTEP(TAUNT_SPEED, IMG_ORG_IDLE + 1),
  ASTEP(TAUNT_SPEED, IMG_ORG_IDLE + 2),
  ASTEP(TAUNT_SPEED, IMG_ORG_IDLE + 4),
  ASTEP(TAUNT_SPEED, IMG_ORG_IDLE + 5),
  ASTEP(TAUNT_SPEED, IMG_ORG_IDLE + 6),
  ASTEP(TAUNT_SPEED, IMG_ORG_IDLE + 7),
  ASTEP(TAUNT_SPEED, IMG_ORG_IDLE + 6),
  ASTEP(TAUNT_SPEED, IMG_ORG_IDLE + 7),
  ASTEP(TAUNT_SPEED, IMG_ORG_IDLE + 5),
  ASTEP(TAUNT_SPEED, IMG_ORG_IDLE + 4),
