...
const TFloat VELOCITY = 4.0 / FACTOR;
...
static ANIMSCRIPT tauntAnimation[] = {
  ...
  ASTEP(TAUNT_SPEED - 10, IMG_GOBLIN_SNIPER_IDLE + 6),
  ASTEP(TAUNT_SPEED, IMG_GOBLIN_SNIPER_IDLE + 5),
  ASTEP(TAUNT_SPEED, IMG_GOBLIN_SNIPER_IDLE + 6),
  ASTEP(TAUNT_SPEED, IMG_GOBLIN_SNIPER_IDLE + 7),
  ASTEP(TAUNT_SPEED - 10, IMG_GOBLIN_SNIPER_IDLE + 6),
...
static ANIMSCRIPT hitLeftAnimation[] = {
  ...
  ADELTA(-9, 0),
  AFILL(COLOR_WHITE),
  AFLIP(HIT_SPEED * 2, IMG_GOBLIN_SNIPER_DAMAGE_RIGHT + 0),
  ADELTA(-1, 0),
  AFILL(-1),
  AFLIP(HIT_SPEED * 2, IMG_GOBLIN_SNIPER_DAMAGE_RIGHT + 1),
  ADELTA(-1, 0),
  AFILL(COLOR_WHITE),
  AFLIP(HIT_SPEED * 2, IMG_GOBLIN_SNIPER_DAMAGE_RIGHT + 2),
  ADELTA(-1, 0),
  AFILL(-1),
  AFLIP(HIT_SPEED * 2, IMG_GOBLIN_SNIPER_DAMAGE_RIGHT + 3),
  AEND
};
