...
static ANIMSCRIPT idleDownAnimation[] = {
  ABITMAP(RAT_SLOT), ALABEL,
  ASIZE(RAT_RECT_X, RAT_RECT_Y, RAT_RECT_W, RAT_RECT_H),
...
static ANIMSCRIPT attackDownAnimation[] = {
  ...
  ATYPE(STYPE_EBULLET),
  ASIZE(RAT_RECT_X, RAT_RECT_Y + 16, RAT_RECT_W, RAT_RECT_H + 16),
...
static ANIMSCRIPT attackLeftAnimation[] = {
  ...
  ATYPE(STYPE_EBULLET),
  ASIZE(RAT_RECT_X - 16, RAT_RECT_Y, RAT_RECT_W + 16, RAT_RECT_H),
...
static ANIMSCRIPT attackRightAnimation[] = {
  ...
  ATYPE(STYPE_EBULLET),
  ASIZE(RAT_RECT_X, RAT_RECT_Y, RAT_RECT_W + 16, RAT_RECT_H),
...
GRatProcess::GRatProcess(GGameState *aGameState, TInt aIp, TFloat aX, TFloat aY, TUint16 aParams)
  ...
  mSprite->cx = RAT_RECT_X;
  mSprite->cy = RAT_RECT_Y;
  mSprite->w = RAT_RECT_W;
  mSprite->h = RAT_RECT_H;
