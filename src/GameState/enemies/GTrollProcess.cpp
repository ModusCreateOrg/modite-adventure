...
static ANIMSCRIPT deathDownAnimation[] = {
    ABITMAP(TROLL_SLOT),
    ADELTA(0, -1),
    ASTEP(DEATH_SPEED, IMG_TROLL_DAMAGE_DOWN + 3),
    ADELTA(0, -1),
    ASTEP(DEATH_SPEED, IMG_TROLL_DAMAGE_DOWN + 1),
    ADELTA(0, -1),
    ASTEP(DEATH_SPEED, IMG_TROLL_DAMAGE_DOWN + 2),
    ADELTA(0, -1),
    ASTEP(DEATH_SPEED, IMG_TROLL_DAMAGE_DOWN + 0),
    AEND,
};
...
static ANIMSCRIPT deathLeftAnimation[] = {
  ABITMAP(TROLL_SLOT),
  ADELTA(-3, -1),
  AFLIP(DEATH_SPEED, IMG_TROLL_DAMAGE_RIGHT + 3),
  ADELTA(-7, -1),
  AFLIP(DEATH_SPEED, IMG_TROLL_DAMAGE_RIGHT + 1),
  ADELTA(-7, -1),
  AFLIP(DEATH_SPEED, IMG_TROLL_DAMAGE_RIGHT + 2),
  ADELTA(-3, -1),
  AFLIP(DEATH_SPEED, IMG_TROLL_DAMAGE_RIGHT + 0),
  AEND,
};
...
static ANIMSCRIPT deathRightAnimation[] = {
  ABITMAP(TROLL_SLOT),
  ADELTA(0, 0),
  ASTEP(DEATH_SPEED, IMG_TROLL_DAMAGE_RIGHT + 3),
  ADELTA(0, 0),
  ASTEP(DEATH_SPEED, IMG_TROLL_DAMAGE_RIGHT + 1),
  ADELTA(0, 0),
  ASTEP(DEATH_SPEED, IMG_TROLL_DAMAGE_RIGHT + 2),
  ADELTA(0, 0),
  ASTEP(DEATH_SPEED, IMG_TROLL_DAMAGE_RIGHT + 0),
  AEND,
};
...
static ANIMSCRIPT deathUpAnimation[] = {
  ABITMAP(TROLL_SLOT),
  ADELTA(0, 0),
  ASTEP(DEATH_SPEED, IMG_TROLL_DAMAGE_UP + 3),
  ADELTA(0, 0),
  ASTEP(DEATH_SPEED, IMG_TROLL_DAMAGE_UP + 1),
  ADELTA(0, 0),
  ASTEP(DEATH_SPEED, IMG_TROLL_DAMAGE_UP + 2),
  ADELTA(0, 0),
  ASTEP(DEATH_SPEED, IMG_TROLL_DAMAGE_UP + 0),
  AEND,
};
