...
GDoorProcess::GDoorProcess(GGameState *aGameState, TUint16 aParam, TFloat aX, TFloat aY, TBool aWood,
  ...
  if (mHorizontal) {
    mSprite1 = new GAnchorSprite(999, ENVIRONMENT_SLOT, aWood ? IMG_WOOD_DOOR_H : IMG_METAL_DOOR_H, STYPE_ENEMY);
  } else {
    mSprite1 = new GAnchorSprite(999, ENVIRONMENT_SLOT, aWood ? IMG_WOOD_DOOR_V : IMG_METAL_DOOR_V, STYPE_ENEMY);
  }
  ...
  if (!mHorizontal) {
    mSprite2 = new GAnchorSprite(999, ENVIRONMENT_SLOT, aWood ? IMG_WOOD_DOOR_V - 10 : IMG_METAL_DOOR_V - 10,
                                 STYPE_ENEMY);
